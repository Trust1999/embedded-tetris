...
//to save button
pub static BUTTON1: LazyLock<Mutex<Option<PinDriver<'static, Gpio4, Input>>>> =
    LazyLock::new(|| Mutex::new(None));
pub static BUTTON2: LazyLock<Mutex<Option<PinDriver<'static, Gpio5, Input>>>> =
    LazyLock::new(|| Mutex::new(None));
pub static BUTTON3: LazyLock<Mutex<Option<PinDriver<'static, Gpio6, Input>>>> =
    LazyLock::new(|| Mutex::new(None));
pub static BUTTON4: LazyLock<Mutex<Option<PinDriver<'static, Gpio7, Input>>>> =
    LazyLock::new(|| Mutex::new(None));
